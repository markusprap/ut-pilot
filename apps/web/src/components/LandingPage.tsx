...
import { ArrowRight, BookOpen, BrainCircuit, GraduationCap, ShieldCheck, Sun, Moon, MessageSquare, StickyNote, Sparkles, Heart, Coffee, CheckCircle2, Zap, Users, Globe } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3">
              ...
              />
              <span className="font-bold text-xl tracking-tight text-slate-900 dark:text-white hidden sm:inline-block">
                UT-Pilot <span className="text-[10px] align-top bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded-full ml-0.5">Beta 3</span>
              </span>
            </div>
      ...
      <div className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-900/30 border border-blue-100 dark:border-blue-800 text-blue-600 dark:text-blue-400 text-xs font-semibold uppercase tracking-wide mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            New: AI Tutor & Discussion Partner (Beta 3)
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-md transition-shadow">
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                Rangkuman materi otomatis dari modul. Tersedia dalam mode Normal, Mudah, dan Analogi untuk pemahaman lebih cepat.
              </p>
            </div>

            {/* Feature 2: NEW Highlight Stabilo */}
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-md transition-shadow relative overflow-hidden group">
              <div className="absolute top-0 right-0 bg-yellow-400 text-slate-900 text-[10px] font-bold px-2 py-1 rounded-bl-lg">BARU</div>
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Interactive Highlight</h3>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                Tandai poin penting di ringkasan materi dengan fitur <b>Stabilo</b>. "Corat-coret" digital untuk ingatan lebih kuat.
              </p>
            </div>

            {/* Feature 3: Enhanced PDF Reader */}
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-md transition-shadow">
              <div className="w-12 h-12 bg-red-100 dark:bg-red-900/30 rounded-xl flex items-center justify-center mb-6">
                <StickyNote className="w-6 h-6 text-red-600 dark:text-red-400" />
              </div>
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Enhanced PDF Reader</h3>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                Baca modul asli dengan nyaman. Support zoom responsif (anti-potong di HP!), mode gelap, dan navigasi bab cepat.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-md transition-shadow relative overflow-hidden">
              <div className="absolute top-0 right-0 bg-green-500 text-white text-[10px] font-bold px-2 py-1 rounded-bl-lg">PREMIUM</div>
              <div className="w-12 h-12 bg-purple-100 dark:bg-purple-900/30 rounded-xl flex items-center justify-center mb-6">
                <GraduationCap className="w-6 h-6 text-purple-600 dark:text-purple-400" />
              </div>
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Exam Simulation</h3>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                Latihan soal UAS adaptif berbasis AI. Prediksi soal yang mungkin keluar dan pelajari pembahasannya.
              </p>
            </div>

            {/* Feature 5: AI Tutor & Discussion */}
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">AI Tutor & Diskusi</h3>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                Buntu tugas diskusi Tuton? Gunakan AI untuk cari referensi & susun argumen. Chat 24/7 dengan tutor pribadi.
              </p>
            </div>

            {/* Feature 6: Community Library */}
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Community Library</h3>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                Akses ratusan modul yang sudah diupload teman lain. Ambil kelas gratis tanpa upload ulang. Berbagi itu indah!
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800 py-10 mt-auto transition-colors">
        <div className="max-w-5xl mx-auto px-4 flex flex-col items-center text-center gap-4">
          <div className="flex flex-col items-center gap-2">
            <p className="text-slate-900 dark:text-slate-200 font-semibold text-sm">© 2025 UT-Pilot Beta 3. Asisten Belajar Cerdas.</p>
